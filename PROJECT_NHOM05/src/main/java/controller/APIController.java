            ...
            if(Servlet.isAllowed(req, AccessLevel.OWNER)){
                if (operation == 4) {
                    ...
                    for(Room room:roomList){
                        if(room.getAvailability() == "Đã được đặt"){
                            occupiedRooms++;
                        }
                        if(room.getAvailability() == "Còn trống"){
                            availableRooms++;
                        }
                        if(room.getAvailability() == "Đã đặt trước") {
                        	bookedRooms++;
                        }
                    }
                    ...
                    json.append("\"bookedRooms\": " + bookedRooms + ",");

                    json.append("\"totalRooms\": " + (occupiedRooms + availableRooms + bookedRooms) + ",");
