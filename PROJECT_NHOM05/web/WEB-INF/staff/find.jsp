...
<div class="content">
    ...
    <div class="edit">
        <c:if test="${sessionStaff.getId() != staff.getId()}">
            <button class="delete" onclick="openModal('${staff.getName()}')">Xóa</button>
        </c:if>
        <button onclick="window.location.href='/staff/${staff.getId()}/edit';">Sửa</button>
    </div>
...
<div class="modal" id="modal-delete">
    <div class="modal-content">
        ...
        <div class="modal-footer">
            ...
            <button onclick="link(${staff.getId()})" class="cancel"> Xóa </button>
        </div>
    </div>
</div>
</body>
